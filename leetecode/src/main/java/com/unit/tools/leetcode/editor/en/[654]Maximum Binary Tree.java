package com.unit.tools.leetcode.editor.en;//You are given an integer array nums with no duplicates. A maximum binary tree
...
class Solution654 {
    ...
    private TreeNode dfs(int[] nums, int left, int right) {
        ...
        int max_index = left, max = Integer.MIN_VALUE;
        ...
        root.left = dfs(nums, left, max_index - 1);
